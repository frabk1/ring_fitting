...
* **Filename**:          test_extraction.py
* **Author**:            Frank Myhre
* **Description**:       Pytests for ring-point extraction utilities.
  
====================================

**Notes**
* Verifies array squeezing, RBP peak finding, edge handling, blanking, and iteration caps.
"""
...
def _make_image(h, w, peaks):
    """
    Make a simple image with injected peaks.

    **Args**:
    * h (int): image height (rows).
    * w (int): image width (cols).
    * peaks (iterable): iterable of (x, y, value); x is column, y is row.

    **Returns**:
    * img (np.ndarray): 2D float image with peaks.
